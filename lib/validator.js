...
module.exports = {
   ...
   * }
   */
   getErrors : Core.validateWithHandlers(R.always([]), R.map(Annotate.annotateWithDefaultErrorMessage)),
   ...
   */
    ...
    */
   validateOrThrow : Core.validateWithErrorHandler(throwErrors),
