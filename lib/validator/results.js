 ...
 */
 ...
 var isOptionallyOmitted = R.allPass([R.propEq('required', false), R.propEq('value', undefined)]);


var isPassingResult = R.anyPass([satisfiedPredicate, isOptionallyOmitted]);
